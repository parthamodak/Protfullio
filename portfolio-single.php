    ...
    <body class="theme-bg">
        ...
        <main>
            ...
            <?php 
                ...
                $portfolio_query_from_db=mysqli_query($db_connect, $portfolio_query);              
                $single_postfolio=mysqli_fetch_assoc($portfolio_query_from_db);                                                 
            ?>
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="backend/uploads/portfolios/<?=$single_postfolio['portfolio_photo']?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?=$single_postfolio['portfolio_title']?></h2>
                                    <p><?=$single_postfolio['portfolio_description']?></p>
